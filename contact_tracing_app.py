...
class MainWindow:
    def __init__(self):
        ...
        self.frame = tk.Frame(self.window, bg='white')  # Create a frame
        self.frame.pack(fill='both', expand=True)  # Pack the frame to fill the window

        self.background_photo = None  # Store the PhotoImage object
...
# Create an instance of MainWindow and run the application
app = MainWindow()
app.run()
